...
function step(){
    if(i == -1){
        ...
        layer.add(new Konva.Line({points: [(w/2)+((h-140)/Math.sqrt(3)), 140, (w/2)-((h-140)/Math.sqrt(3)), 140], stroke: 'green', strokeWidth: 3}));
        layer.add(new Konva.Line({points: [(w/2)-((h-140)/Math.sqrt(3)), 140, w/2, h], stroke: 'green', strokeWidth: 3}));
        layer.add(new Konva.Line({points: [w/2, h, (w/2)+((h-140)/Math.sqrt(3)), 140], stroke: 'green', strokeWidth: 3}));
        canvas.add(layer);
